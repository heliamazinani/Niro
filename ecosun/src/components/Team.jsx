      ...
      answer: (
        <div className="list-arrow mt-50">
          <ul className="rest">
            ...
            <li className="mb-20">
              <p>
                دانشجوی رتبه اول و المپیادی دانشگاه فردوسی مشهد در دوره کارشناسی
              </p>
            </li>
            <li className="mb-20">
              <p>
            ...
            <li className="mb-20">
              <p>
                پیمانکار اجرای تاسیسات الکتریکی سالنهای کلرزنی ایستگاههای شماره
                2،1 ، تعادلی و 4 پمپاژ آب از سد دوستی به مشهد
              </p>
            </li>
            <li className="mb-20">
              <p>
                پیمانکار اجرای تاسیسات الکتریکی مخزن یک میلیون متر مکعبی آب شرب
                مشهد
              </p>
            </li>
            <li className="mb-20">
            ...
            <li className="mb-20">
              <p>
                پیمانکار نصب و راه اندازی تابلوهای برق واحد انتقال نفت خام سرکان
                و ماله کوه لرستان
              </p>
            </li>
            <li className="mb-20">
            ...
            <li className="mb-20">
              <p>
                پیمانکار اجرای تاسیسات الکتریکی و دوربینهای مدار بسته کارخانه
                خوراک دام و طیور گهردانه شرق
              </p>
            </li>
            <li className="mb-20">
              <p>
