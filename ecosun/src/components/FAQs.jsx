...
const FAQs = () => {
  ...
  const faqs = [
    ...
    {
      question: "چه عواملی باعث خرابی تابلو برق صنعتی می‌شوند؟",
      answer:
        "عوامل محیطی مانند رطوبت، دما و ورود حیوانات موذی و همچنین عوامل داخلی مانند اتصالات ضعیف، خرابی عایق و اضافه بار می‌توانند باعث خرابی تابلو شوند.",
    },
    {
