...
import sq1 from "/assets/imgs/sass-img/work/1.jpg";
                ...
                <div className="swiper-wrapper">
                  {[...Array(5)].map((_, i) => (
                    <div className="swiper-slide" key={i}>
                      <div className="item">
                        <div className="img">
                          <img src={sq1} alt={`slide-${i}`} />
                          <div className="cont">
                            <span className="mb-5">برندینگ</span>
                            <h6 className="fz-18">استودیو آرت بورد</h6>
                          </div>
                        </div>
                      </div>
                    </div>
