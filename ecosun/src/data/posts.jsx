    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <h2>جمع‌بندی</h2>
          <p>
            پنل‌های مونوکریستال در هوای ابری عملکرد بهتری دارند . همچنین فناوری‌هایی
            مانند PERC، هاف‌سل و TOPCon با هدف بهبود راندمان ارائه شده‌اند.
            به‌طور کلی، هوای ابری نگرانی جدی برای نیروگاه‌های خورشیدی ایجاد
            نمی‌کند، چراکه بیشتر پنل‌ها در هوای نیمه‌ابری بیش از ۵۰٪ توان نامی
