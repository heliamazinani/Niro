              ...
              <div className="row">
                <div className="col-lg-7">
                  <div className="caption">
                    ...
                    <h1 className="fz-55">
                      {" "}
                      با افتخار، منابع انرژی تجدیدپزیر را به نیروی پیشران توسعه
                      ایران تبدیل می کنیم
                    </h1>
                  </div>
                </div>
                ...
                <div className="col-lg-5">
                  <div className="sec-lg-head mb-80">
                    ...
                    <p className="fz-15 mt-10">
                      ما به ارتباط با مشتریان و کاربران خود اهمیت زیادی می‌دهیم.
                      اگر سوالی دارید، نیاز به مشاوره دارید یا می‌خواهید اطلاعات
                      بیشتری درباره خدمات ما کسب کنید، لطفاً با ما تماس بگیرید.
                    </p>
